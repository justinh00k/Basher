...
var banned_words = ["dick", "retard", "asshole", "shit", "shitting", "fuck", "fucking", "fag", "faggot", "tranny", "bitch", "fucker", "cunt", "nigger", "nigga", "slut", "twat", "pussy", "cock", "boner", "motherfucker", "hitler", "penis", "clit"];

// OK: Ass, Damn, Ejaculate, Erection, Penis, Vagina
...
/*
exports.mass_add_demerits = functions.https.onRequest(async(req, res) => {


    firestore.collection("Stories").get().then((snapshot) => {
...
function check_dictionary(the_word) {
    ...
    if (banned_words.indexOf(the_word) > -1 || banned_words.indexOf(the_word.substring(0, the_word.length - 1)) > -1 || the_word === "cum" || the_word === "ass")
        return false;
